...
class HabitTestCase(InitialTestCase):
    ...
    def test_create_habit(self):
        ...
        response = self.client.post(reverse('main:habit_create'), data=data)
    ...
    def test_retrieve_habit(self):
        ...
        response = self.client.get((reverse('main:habit_detail', kwargs={'pk': self.habit.id})))
    ...
    def test_update_habit(self):
        ...
        response = self.client.patch(
            reverse('main:habit_change', kwargs={'pk': self.habit.id}),
            data=data
        )
    ...
    def test_destroy_habit(self):
        ...
        response = self.client.delete(
            reverse('main:habit_delete', kwargs={'pk': self.habit.id})
        )
