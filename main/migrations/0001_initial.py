# Generated by Django 5.0.3 on 2024-03-09 12:31
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('period', models.CharField(choices=[('1', 'ежедневно'), ('2', 'раз в два дня'), ('3', 'раз в три дня'), ('4', 'раз в четыре дня'), ('5', 'раз в пять дней'), ('6', 'раз в шесть дней'), ('7', 'раз в семь дней')], default='1', max_length=20, verbose_name='периодичность привычки')),
                ...
                ('connected_habit', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='main.habit', verbose_name='связанная привычка')),
